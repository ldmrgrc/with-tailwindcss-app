...
export const Banner: FC<Props> = ({ netflixOriginals }) => {
    ...
    return (
        <div className="flex flex-col space-y-2 py-16 md:space-y-4 lg:h-[65vh] lg:justify-end lg:pb-12">
            ...
            <p className="max-w-xs text-xs require('tailwindcss-textshadow')
 md:max-w-lg md:text-lg lg:max-w-2xl lg:text-2xl">
            ...
            <div className='flex space-x-3'>
                ...
                <button className="bannerButton bg-[gray]/70">Mas información <InformationCircleIcon className='w-5 h-5 md:h-8 md:w-8' /></button>
            </div>
        </div>
    );
};
